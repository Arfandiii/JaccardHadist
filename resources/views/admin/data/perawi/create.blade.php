    ...
    <main class="container mx-auto px-6 py-8">
        <div class="mb-6 flex items-center text-sm text-gray-900 space-x-2">
            <a href="{{ url()->previous() }}" class="text-green-600 hover:underline font-medium">&larr;
                Kembali</a>
            <span>/</span>
            <h2 class="font-bold mb-2 text-center text-3xl">Tambah Data Perawi</h2>
        </div>
        <div class="p-6 mb-10 mx-auto bg-white rounded-lg shadow-md">
            <div class="flex flex-wrap w-full mx-auto">
                <form action="{{ route('admin.perawi.store') }}" method="POST"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="nama_perawi" id="nama_perawi" required
                            ...
                            placeholder="Masukkan Nama Perawi" value="{{ old('nama_perawi') }}">
                        @error('nama_perawi')
