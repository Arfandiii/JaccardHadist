    ...
    <main class="container mx-auto px-6 py-8">
        <div class="mb-6 flex items-center text-sm text-gray-900 space-x-2">
            <a href="{{ route('admin.dashboard.data') }}" class="text-green-600 hover:underline font-medium">&larr;
                Kembali</a>
            <span>/</span>
            <h2 class="font-bold mb-2 text-center text-3xl">Ubah Data kitab</h2>
        </div>
        <div class="p-6 mb-10 mx-auto bg-white rounded-lg shadow-md">
            <div class="flex flex-wrap w-full mx-auto">
                <form action="{{ route('admin.kitab.update', $kitab->id) }}" method="POST"
                    ...
                    @method('PUT')
                    <div class="mb-2">
                        <label for="nama_kitab" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">
                            Nama Kitab
                        </label>
                        <input type="text" name="nama_kitab" id="nama_kitab" required
                            ...
                            placeholder="Masukkan Nama Kitab" value="{{ old('nama_kitab', $kitab->nama_kitab) }}">
                        @error('nama_kitab')
