@if(isset($data) && $tipe === 'kitab')
<div id="kitab-table" class="mt-8 bg-white shadow-md rounded-lg p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <!-- Tombol X -->
            <button onclick="document.getElementById('kitab-table').classList.add('hidden')" title="Tutup Tabel"
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200">
        <table class="min-w-full table-auto text-left">
            ...
            <tbody>
                    ...
                    <td class="py-5 px-6">
                        <div class="flex space-x-2 justify-center">
                            ...
                            <div class="relative before:content-[attr(data-tip)] before:absolute before:px-2 before:py-1 before:left-1/2 before:-top-3 before:w-max before:max-w-xs before:-translate-x-1/2 before:-translate-y-full before:bg-gray-700 before:text-white before:rounded-md before:opacity-0 before:transition-all after:absolute after:left-1/2 after:-top-3 after:h-0 after:w-0 after:-translate-x-1/2 after:border-8 after:border-t-gray-700 after:border-l-transparent after:border-b-transparent after:border-r-transparent after:opacity-0 after:transition-all hover:before:opacity-100 hover:after:opacity-100"
                                data-tip="Edit Kitab">
                                <a href="{{ route('admin.kitab.edit', $kitab->id) }}" class=" flex
                            ...
                            <form action="{{ route('admin.kitab.destroy', $kitab->id) }}" method="POST"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
                                <div class="relative before:content-[attr(data-tip)] before:absolute before:px-2 before:py-1 before:left-1/2 before:-top-3 before:w-max before:max-w-xs before:-translate-x-1/2 before:-translate-y-full before:bg-gray-700 before:text-white before:rounded-md before:opacity-0 before:transition-all after:absolute after:left-1/2 after:-top-3 after:h-0 after:w-0 after:-translate-x-1/2 after:border-8 after:border-t-gray-700 after:border-l-transparent after:border-b-transparent after:border-r-transparent after:opacity-0 after:transition-all hover:before:opacity-100 hover:after:opacity-100"
                                    data-tip="Delete Kitab">
                                    <button type="submit"
                                        onclick="return confirm('Apakah Anda yakin ingin menghapus data kitab ini?')"
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-6 text-center text-gray-500">Tidak ada data kitab.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
