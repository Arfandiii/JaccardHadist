...
@section('content')
<div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 align-middle">
    <div class="p-6 mx-auto bg-white rounded-lg shadow-md my-10 h-full ">
        <div class="flex flex-wrap w-full my-5 -mx-2">
            <div class="max-w-6xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-lg">
                <h1 class="text-3xl font-semibold mb-8 text-green-700 text-center">Edit Profil Admin</h1>
                ...
                <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}"
                                class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-400 transition">
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-8">
                        <a href="{{ route('admin.dashboard.profile') }}"
                            class="text-gray-500 hover:text-green-600 transition font-medium">← Batal</a>
                        <button type="submit"
                            class="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition cursor-pointer">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
